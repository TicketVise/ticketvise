          ...
          <div class="hidden md:block md:ml-10">
            <div class="flex space-x-4">
              ...
              <router-link
                ...
                exact
                class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700"
                active-class="ext-white bg-gray-900"
                >Admin
              </router-link>
            </div>
          </div>
        </div>
        <div v-on-clickaway="away_mobile">
            ...
            <div class="ml-4 flex items-center md:ml-6">
              <div class="relative flex items-center">
                <button
                  v-show="isFramed()"
                  @click="openInTab()"
                  class="mr-6 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
                >
                  <svg
                    class="w-6 h-6 mr-2"
                    fill="none"
                ...
                <div class="mr-1">
                  ...
                  >
                    ...
                    >
                      <a
                        href="https://ticketvise.com/getting-started/"
                        target="_blank"
                      ...
                      <a
                        href="mailto:info@ticketvise.com?subject=Feedback&body=Hi%20TicketVise,"
                        target="_blank"
