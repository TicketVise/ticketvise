  ...
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    <header class="bg-white shadow rounded-lg pb-4 mb-4">
      ...
      <div class="grid md:grid-cols-3 gap-4 mx-4">
        <div class="rounded-md border flex-grow py-2 px-4 flex md:flex-col-reverse space-x-2 md:space-x-0 items-center md:items-start">
          <div class="flex items-baseline sm:mt-1">
            <h2 class="text-2xl font-medium text-primary">{{ inboxes.length }}</h2>
          </div>
...
<script>
import InboxStats from '@/components/admin/InboxStats'
