<template>
  <div class="py-4 px-2 lg:px-4 overflow-y-auto">
    <h3 class="text-lg leading-6 font-medium text-gray-900 px-4 pb-1" v-if="statistics">
      Last week
    </h3>

    <div class="sm:rounded border grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 mb-4" v-if="statistics">
      <div class="flex-grow border-r border-b xl:border-b-0 p-4">
        <h3 class="text-lg leading-6 font-medium text-gray-900">
          Pending
        </h3>
        <div class="flex items-baseline mt-1">
          <h2 class="text-2xl font-medium text-primary">{{ statistics.current_week_pending }}</h2>
      ...
      <div class="flex-grow border-b xl:border-b-0 xl:border-r p-4">
        <h3 class="text-lg leading-6 font-medium text-gray-900">
          Assigned
        </h3>
        <div class="flex items-baseline mt-1">
          <h2 class="text-2xl font-medium text-primary">{{ statistics.current_week_assigned }}</h2>
      ...
      <div class="flex-grow p-4 border-b lg:border-b-0 lg:border-r">
        <h3 class="text-lg leading-6 font-medium text-gray-900">
          Answered
        </h3>
        <div class="flex items-baseline mt-1">
          <h2 class="text-2xl font-medium text-primary">{{ statistics.current_week_answered }}</h2>
      ...
      <div class="flex-grow p-4">
        ...
        <div class="flex items-baseline mt-1">
          <h2 class="text-2xl font-medium text-primary">{{ statistics.current_week_closed }}</h2>
    ...
    <div class="flex flex-col md:grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x border mb-4 sm:rounded" v-if="statistics">
      <div class="flex flex-wrap">
        <div class="grow p-4">
          ...
          <div class="flex items-baseline mt-1">
            <h2 class="text-2xl font-medium text-primary">{{ statistics.total_tickets }}</h2>
      ...
      <div class="flex-grow p-4">
        ...
        <div class="flex items-baseline mt-1">
          <h2 class="text-2xl font-medium text-primary">{{ statistics.avg_response_time }} <span
      ...
      <div class="flex-grow p-4">
        ...
        <div class="flex items-baseline mt-1">
          <h2 class="text-2xl font-medium text-primary">{{ statistics.total_guests }}</h2>
        </div>
      </div>
    </div>
