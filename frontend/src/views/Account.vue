              ...
              <div class="bg-white py-6 px-4 sm:p-6">
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-500">
                    Change your basic information here, we won't ask you for
                ...
                <div class="flex">
                  ...
                  <div class="ml-3 flex-1 md:flex md:justify-between">
                    <p class="text-sm text-blue-700">
                      Your account details are given to us by the LTI provider,
              ...
              <td class="px-4 py-2 whitespace-no-wrap">
                <div class="flex flex-col">
                  ...
                  <span class="text-sm leading-5 text-gray-500"
                    >If a comment or reply has been placed on one of your
                    (assigned) tickets</span
                  >
                </div>
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
              ...
              <td class="px-4 py-2 whitespace-no-wrap">
                <div class="flex flex-col">
                  <div>
                    ...
                    <span class="text-xs leading-5 font-small text-gray-400"
                      >(Teacher and TA only)</span
                    >
                  </div>
                  <span class="text-sm leading-5 text-gray-500"
                    >When a new ticket has been created in a inbox</span
                  >
                </div>
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
            ...
            <tr>
              <td class="px-4 py-2 whitespace-no-wrap">
                <div class="flex flex-col">
                  ...
                  <span class="text-sm leading-5 text-gray-500"
                    >If a new ticket is assigned to you</span
                  >
                </div>
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
            ...
            <tr>
              <td class="px-4 py-2 whitespace-no-wrap">
                <div class="flex flex-col">
                  ...
                  <span class="text-sm leading-5 text-gray-500"
                    >If a ticket assigned to you is unanswered for a certain
                    amount of time</span
                  >
                </div>
              </td>
            ...
            <tr>
              <td class="px-4 py-2 whitespace-no-wrap">
                <div class="flex flex-col">
                  ...
                  <span class="text-sm leading-5 text-gray-500"
                    >If a fellow teacher mentions you in a ticket</span
                  >
                </div>
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
...
export default {
  ...
  mounted() {
    axios.get("/api/me/statistics").then((response) => {
      this.stats.find((s) => s.label === "Inboxes").value =
        response.data.inboxes || 0;
      this.stats.find((s) => s.label === "Tickets").value =
        response.data.tickets || 0;
      this.stats.find((s) => s.label === "Public tickets").value =
        response.data.public_tickets || 0;
    });
