                  ...
                  <div class="flex-grow space-y-4">
                    <div>
                      ...
                      <div class="mt-1 rounded-md flex">
                        <input disabled type="text" name="username" id="username" autocomplete="username" class="focus:ring-sky-500 focus:border-sky-500 flex-grow block w-full min-w-0 rounded-md sm:text-sm border-gray-300" :value="user.username" />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="mt-1 rounded-md flex">
                        <input disabled type="text" name="email" id="email" autocomplete="email" class="focus:ring-sky-500 focus:border-sky-500 flex-grow block w-full min-w-0 rounded-md sm:text-sm border-gray-300" :value="user.email" />
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <div class="ml-5 rounded-md">
                          <div class="group relative border border-gray-300 rounded-md py-2 px-3 flex items-center justify-center hover:bg-gray-50 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-sky-500">
                            <label for="user-photo" class="relative text-sm leading-4 font-medium text-gray-300 pointer-events-none">
                              <span>Change</span>
                              <span class="sr-only"> user photo</span>
                            </label>
                            <input id="user-photo" name="user-photo" type="file" disabled class="absolute w-full h-full opacity-0 cursor-pointer border-gray-300 rounded-md" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="rounded-md bg-blue-50 p-4">
                <div class="flex">
                  ...
                  <div class="ml-3 flex-1 md:flex md:justify-between">
                    <p class="text-sm text-blue-700">Your account details are given to us by the LTI provider, so you can't change them here.</p>
                  </div>
                </div>
              </div>
              <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                <button disabled type="submit" class="bg-primary-100 border border-transparent rounded-md py-2 px-4 inline-flex justify-center text-sm font-medium text-primary-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">Save</button>
        ...
        <table class="min-w-full divide-y divide-gray-200 shadow rounded sm:overflow-hidden">
          <thead>
            <tr>
              ...
              <th class="px-4 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">In-app</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications()" type="checkbox" class="border-2" v-model="settings.notification_comment_app" />
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications" type="checkbox" class="border-2" v-model="settings.notification_comment_mail" />
              </td>
            </tr>
            <tr>
              <td class="px-4 py-2 whitespace-no-wrap">
              ...
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications()" type="checkbox" class="border-2" v-model="settings.notification_new_ticket_app" />
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications" type="checkbox" class="border-2" v-model="settings.notification_new_ticket_mail" />
              </td>
            </tr>
            <tr>
              <td class="px-4 py-2 whitespace-no-wrap">
              ...
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications()" type="checkbox" class="border-2" v-model="settings.notification_assigned_app" />
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications" type="checkbox" class="border-2" v-model="settings.notification_assigned_mail" />
              </td>
            </tr>
            <tr>
              <td class="px-4 py-2 whitespace-no-wrap">
              ...
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications()" type="checkbox" class="border-2" v-model="settings.notification_ticket_reminder_app" />
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications" type="checkbox" class="border-2" v-model="settings.notification_ticket_reminder_mail" />
              </td>
            </tr>
            <tr>
              <td class="px-4 py-2 whitespace-no-wrap">
              ...
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications()" type="checkbox" class="border-2" v-model="settings.notification_mention_app" />
              </td>
              <td class="px-4 py-2 whitespace-no-wrap">
                <input @change="updateNotifications" type="checkbox" class="border-2" v-model="settings.notification_mention_mail" />
              </td>
            </tr>
          </tbody>
        </table>
