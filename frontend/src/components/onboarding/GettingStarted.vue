  ...
  <div class="fixed z-10 inset-0 overflow-y-auto" v-if="modalNumber > 0">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6"
        ...
        <welcome-modal @click="modalNumber = 2" @cancel="finishIntroduction" v-if="modalNumber === 1"></welcome-modal>
        <overview-modal @click="modalNumber = 3" @cancel="modalNumber = 1" v-if="modalNumber === 2"></overview-modal>
        <scheduling-modal @click="modalNumber = 4" @cancel="modalNumber = 2"
                          v-if="modalNumber === 3"></scheduling-modal>
        <labels-modal @click="modalNumber = 5" @cancel="modalNumber = 3" v-if="modalNumber === 4"></labels-modal>
        <statistics-modal @click="modalNumber = 6" @cancel="modalNumber = 4"
                          v-if="modalNumber === 5"></statistics-modal>
        <finished-modal @click="finishIntroduction" @cancel="modalNumber = 5"
