<template>
  ...
  <div
    aria-live="assertive"
    class="fixed top-0 right-0 flex items-start px-8 py-12 pointer-events-none opacity-20 hover:opacity-100 transition-opacity duration-100 ease-in-out"
  >
    <div class="w-full flex flex-col items-end space-y-4">
      ...
      >
        <div
          v-if="show"
          class="bg-white shadow-xl rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5"
        >
          <div class="p-3">
            <div class="flex items-center divide-x">
              <div class="pl-2 pr-4 flex space-x-2">
                ...
                >
                  <div>
                    <MenuButton
                      class="flex items-center text-gray-400 hover:text-gray-500 outline-none"
                    >
                      <UserIcon
                  ...
                  >
                    <MenuItems
                      class="origin-top-right absolute right-0 mt-2 w-36 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none"
                    >
                      <div class="py-1">
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      />
                      <MoonIcon
                        v-else-if="darkmode == 'dark'"
                        class="flex-shrink-0 h-5 w-5"
                        aria-hidden="true"
                      />
                      <ComputerDesktopIcon
                        v-else-if="darkmode == 'media'"
                        class="flex-shrink-0 h-5 w-5"
                        aria-hidden="true"
                      />
                      <ChevronDownIcon
