      ...
      >
        ...
        <div class="mt-2 mb-2">
          <img
            :src="mailboxImage"
            alt="mailbox"
            class="w-2/3 md:w-1/2 mx-auto py-8"
          />
          <p class="text-sm text-gray-500">
            Provide your email address to connect your mailbox to your
            TicketVise inbox.
          </p>
        </div>
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                <h3 class="text-sm font-medium text-red-800">
                  Encountered an error while trying to automatically configure
                  email. Please try again, change your credentials or configure
                  email settings
                  <a
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.error = "";
      axios
        .post(`/api/inboxes/${inboxId}/settings/email`, data)
        .then((resp) => {
