...
def generate_database():
    ...
    comment_19 = Comment.objects.create(
        author=user_tom, ticket=ticket_19, is_reply=True, content="Maybe you can borrow a laptop from one of your peers.",
    )
    ...
    comment_22 = Comment.objects.create(author=user_jelle, ticket=ticket_22, is_reply=True, content="Yes! Cool, right?", )
    ...
    comment_34 = Comment.objects.create(author=user_ana, ticket=ticket_34, is_reply=True, content="Should be fixed now", )
    add_date_to_comment(comment_34, datetime.timedelta(days=28, hours=13))

    comment_35 = Comment.objects.create(
        author=user_ana, ticket=ticket_35, is_reply=True, content="No, but it is highly recommended to join them...",
    )
    add_date_to_comment(comment_35, datetime.timedelta(days=28, hours=13))

    comment_36 = Comment.objects.create(author=user_ana, ticket=ticket_36, is_reply=True, content="Only the papers!", )
