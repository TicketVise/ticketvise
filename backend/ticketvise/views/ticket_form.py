...
from .api.security import UserIsInCourseMixin


class TicketFormView(UserIsInCourseMixin, TemplateView):
    """
    Form for submitting new tickets.

    :var User user: The user visiting the page.
    :var Course course: The course of the ticket.
    :var int course_id: The id of the ticket.
    :var int course_id: The id of the ticket.
