# Generated by Django 3.1 on 2020-08-24 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image',
                 models.ImageField(default='/static/img/inboxes/default-inbox.png', upload_to='media/img/inboxes')),
                ('scheduling_algorithm', models.CharField(
                    choices=[('round-robin', 'Round Robin'), ('least-assigned-first', 'Least Assigned First'),
                             ('manual', 'Manual')], default='least-assigned-first', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#ff0000', max_length=7,
                                           validators=[ticketvise.models.validators.validate_hex_color])),
                ('name', models.CharField(default='', max_length=50)),
                ('is_visible_to_guest', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('date_edited', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('inbox', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='labels',
                                            to='ticketvise.inbox')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('PNDG', 'Pending'), ('ASGD', 'Assigned'), ('ANSD', 'Answered'), ('CLSD', 'Closed')],
                    default='PNDG', max_length=8)),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickets',
                                             to=settings.AUTH_USER_MODEL)),
                ('inbox', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickets',
                                            to='ticketvise.inbox')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('ticketevent_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='ticketvise.ticketevent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(
                    choices=[('GUEST', 'Student'), ('AGENT', 'Teaching Assistant'), ('MANAGER', 'Coordinator')],
                    default='GUEST', max_length=40)),
                ('is_bookmarked', models.BooleanField(default=False)),
                ('date_edited', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('inbox',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_relationship',
                                   to='ticketvise.inbox')),
                ('user',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inbox_relationship',
                                   to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_edited', models.DateTimeField(auto_now=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments',
                                             to='ticketvise.ticket')),
            ],
        ),
        migrations.AddField(
            model_name='ticket',
            name='labels',
            field=models.ManyToManyField(blank=True, related_name='tickets', through='ticketvise.TicketLabel',
                                         to='ticketvise.Label'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='shared_with',
            field=models.ManyToManyField(blank=True, through='ticketvise.TicketSharedUser',
                                         to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('notification_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='ticketvise.notification')),
                ('old_status', models.CharField(
                    choices=[('PNDG', 'Pending'), ('ASGD', 'Assigned'), ('ANSD', 'Answered'), ('CLSD', 'Closed')],
                    max_length=8, null=True)),
                ('new_status', models.CharField(
                    ...
                    max_length=8)),
                ('ticket',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_notifications',
                                   to='ticketvise.ticket')),
            ],
            ...
            fields=[
                ('notification_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='ticketvise.notification')),
                ('comment',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mention_notifications',
                                   to='ticketvise.comment')),
            ],
            bases=('ticketvise.notification',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('notification_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='ticketvise.notification')),
                ('comment',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_notifications',
                                   to='ticketvise.comment')),
            ],
            bases=('ticketvise.notification',),
        ),
